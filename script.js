...
function changeImage() {
    ...
    document.getElementById('twotwo').src = 'images/0202.jpg';
}

function changeCaption() {
    var captionBox1 = document.getElementById('caption-box-1');
    captionBox1.style.display = 'block'
    document.getElementById('twotwo').src = '';
...
function changeImage3() {
    var captionBox1 = document.getElementById('caption-box-3');
    captionBox1.style.display = 'none'
    document.getElementById('twofourteen').src = 'images/0214.jpg';
}

function changeCaption3() {
    var captionBox1 = document.getElementById('caption-box-3');
    captionBox1.style.display = 'block'
    document.getElementById('twofourteen').src = '';
}
function changeImage4() {
    var captionBox1 = document.getElementById('caption-box-4');
    captionBox1.style.display = 'none'
    document.getElementById('twotwenty').src = 'images/0220.jpg';
}

function changeCaption4() {
    var captionBox1 = document.getElementById('caption-box-4');
    captionBox1.style.display = 'block'
    document.getElementById('twotwenty').src = '';
}
function changeImage5() {
    var captionBox1 = document.getElementById('caption-box-5');
    captionBox1.style.display = 'none'
    document.getElementById('twotwentytwo').src = 'images/0222.jpg';
}

function changeCaption5() {
    var captionBox1 = document.getElementById('caption-box-5');
    captionBox1.style.display = 'block'
    document.getElementById('twotwentytwo').src = '';
}
function changeImage6() {
    var captionBox1 = document.getElementById('caption-box-6');
    captionBox1.style.display = 'none'
    document.getElementById('threethirty').src = 'images/0330.jpg';
}

function changeCaption6() {
    var captionBox1 = document.getElementById('caption-box-6');
    captionBox1.style.display = 'block'
    document.getElementById('threethirty').src = '';
}
function changeImage7() {
    var captionBox1 = document.getElementById('caption-box-7');
    captionBox1.style.display = 'none'
    document.getElementById('foureighteen').src = 'images/0418.jpg';
}

function changeCaption7() {
    var captionBox1 = document.getElementById('caption-box-7');
    captionBox1.style.display = 'block'
    document.getElementById('foureighteen').src = '';
}
function changeImage8() {
    var captionBox1 = document.getElementById('caption-box-8');
    captionBox1.style.display = 'none'
    document.getElementById('fourthirty').src = 'images/0430.jpg';
}

function changeCaption8() {
    var captionBox1 = document.getElementById('caption-box-8');
    captionBox1.style.display = 'block'
    document.getElementById('fourthirty').src = '';
}
function changeImage9() {
    var captionBox1 = document.getElementById('caption-box-9');
    captionBox1.style.display = 'none'
    document.getElementById('fiveten').src = 'images/0510.jpg';
}

function changeCaption9() {
    var captionBox1 = document.getElementById('caption-box-9');
    captionBox1.style.display = 'block'
    document.getElementById('fiveten').src = '';
}
function changeImage10() {
    var captionBox1 = document.getElementById('caption-box-10');
    captionBox1.style.display = 'none'
    document.getElementById('fiveeighteen').src = 'images/0518.jpg';
}

function changeCaption10() {
    var captionBox1 = document.getElementById('caption-box-10');
    captionBox1.style.display = 'block'
    document.getElementById('fiveeighteen').src = '';
}
